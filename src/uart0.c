//This file was provided by the instructor and are not my own work
#include "uart0.h"
...
void UART0_Init(void)
{
	...
	UART0->BDL =11;			//Dla CLOCK_SETUP=0 BR=28800	BDL=91 BR=9600	BDL=17	:	CLOCK_SETUP=1	BR=230400		BDL=13
